 ...
 * staff.js  (standalone staff-specific variant)
 *
 * Identical logic to script.js — kept as a separate file
 * in case staff.html requires independent customisation later.
 */
...
/* ============================================================
   8. STEP 2 — STAFF SELECTION (card grid style)
   ============================================================ */
